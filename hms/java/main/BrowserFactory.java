	...
	public static WebDriver createDriver(String type) {
		if (type.contains("chrome") || type.contains("CHROME")) {
			System.setProperty("webdriver.chrome.driver",
					System.getProperty("user.dir") + "//mylibs//chrome//chromedriver.exe");
			driver = new ChromeDriver();
		} else if (type.contains("firefox") || type.contains("FIREFOX")) {
			System.setProperty("webdriver.gecko.driver",
					System.getProperty("user.dir") + "//mylibs//gecko//geckodriver.exe");
			driver = new FirefoxDriver();
		}

		else if (type.contains("IE") || type.contains("ie")) {
			System.setProperty("webdriver.ie.driver",
					System.getProperty("user.dir") + "//mylibs//ie//IEDriverServer_x64_3.14.0//IEDriverServer.exe");
