...
public class Locators {
	...
	public static final String TITLE_DROPDOWNLIST_XPATH = "//select[@id='person']";
	...
	public static final String STATE_DROPDOWNLIST_XPATH = "//select[@id='selectOptions']";
	public static final String CITY_DROPDOWNLIST_XPATH = "//select[@name='city']";
	...
	public static final String DOB_CALENDAR_XPATH = "";
	...
	public static final String SPECIALITY_DROPDOWNLIST_XPATH = "//select[@id='speciality']";
	...
	public static final String LICENSESTATUS_DROPDOWNLIST_XPATH = "//select[@name='licenseStatus']";
